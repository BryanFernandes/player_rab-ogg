...
SoundDevice::audioConverter()
{
  ...
  fprintf(stderr, " sounddevice.cpp VARIABLE VALUE in audioConverter: m_obtained.format: %hu\n", m_obtained.format);
  fprintf(stderr, " sounddevice.cpp VARIABLE VALUE in audioConverter: m_obtained.freq: %d\n", m_obtained.freq);
  fprintf(stderr, " sounddevice.cpp VARIABLE VALUE in audioConverter: m_obtained.channels: %hhu\n", m_obtained.channels);
...
SoundDevice::setSound(Sound *sound)
{
  ...
  fprintf(stderr, " sounddevice.cpp VARIABLE SIZE in setSound: sound: %d\n", sound->size());
